...
public class AssignMembersSiteRole3User3Test extends BaseTestCase {
	public void testAssignMembersSiteRole3User3() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("userfn3 userln3"),
			selenium.getText(
				"//td[@id='_174_usersSearchContainer_col-name_row-usersn3']"));
		assertEquals(RuntimeVariables.replace("usersn3"),
			selenium.getText(
				"//td[@id='_174_usersSearchContainer_col-screen-name_row-usersn3']"));
		assertFalse(selenium.isChecked(
				"//td[@id='_174_usersSearchContainer_col-rowChecker_row-usersn3']/input"));
		selenium.check(
			"//td[@id='_174_usersSearchContainer_col-rowChecker_row-usersn3']/input");
