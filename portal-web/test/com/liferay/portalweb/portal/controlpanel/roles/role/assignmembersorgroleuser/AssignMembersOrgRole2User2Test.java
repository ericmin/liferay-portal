...
public class AssignMembersOrgRole2User2Test extends BaseTestCase {
	public void testAssignMembersOrgRole2User2() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("orgrole2"),
			selenium.getText(
				"//tr[contains(.,'orgrole2')]/td[@headers='_125_ocerSearchContainer_col-name']/a"));
		...
		selenium.clickAt("//tr[contains(.,'orgrole2')]/td[@headers='_125_ocerSearchContainer_col-name']/a",
